...
TYPED_TEST_SUITE(SortTest, SortAlgos);


TYPED_TEST(SortTest, acceptsEmptySequence) {
    this->sortAndEnsureSorted({});
}


TYPED_TEST(SortTest, correctlySortsSequencesWithUniqueElements) {
    // sorted sequences
...
TYPED_TEST(SortTest, correctlySortsSequencesWithRepetitions) {
    // sorted sequences
