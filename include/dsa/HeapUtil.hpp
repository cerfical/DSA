...
namespace dsa {
    ...
    public:
        ...
        HeapUtil(const HeapUtil&) = delete;
        HeapUtil& operator=(const HeapUtil&) = delete;

        HeapUtil(HeapUtil&&) = delete;
        HeapUtil& operator=(HeapUtil&&) = delete;
    ...
    private:
        ...
        static std::size_t largerChildOrNode(const R& range, std::size_t n) {
            return maximum(range, maximum(range, n, leftChildOf(n)), rightChildOf(n));
        }
